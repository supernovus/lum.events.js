 ...
 * status. 
 * 
 * @prop {(module:@lumjs/events~Status|undefined)} state
 * 
 * When a stateful event is emitted, the emit status object will be
 * saved here, and will be used as the `prevEmit` property on future
 * emit status objects for this type. Additionally when new handlers
 * are added to a stateful event type, they will be emitted immediately,
 * using the arguments from the saved `state.args`.
 * 
